...
type PresetPartial = Omit<StrataConfig, 'seed' | 'patternAssignment' | 'lineOpacity' | 'viewMode' | 'extrusion' | 'showDepthNumbers' | 'accentLayerEnabled' | 'accentLayerIndex' | 'format'>;
